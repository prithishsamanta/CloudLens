# Manual smoke test — hits real AWS CloudWatch Logs and Amazon Bedrock, and
# starts the actual local web server. Requires live AWS credentials and an
# existing log group; not run by pytest/CI, and calling Bedrock costs real
# money.
